...
(function (global) {
  const DICT = {
    ar: {
      ...
      login_contact_admin: 'التسجيل الذاتي غير متاح. لطلب حساب أو عرض سعر، تواصل مع مسؤول المنصّة:',
    ...
    en: {
      ...
      login_contact_admin: 'Self-registration is not available. To request an account or a price quote, contact the platform administrator:',
