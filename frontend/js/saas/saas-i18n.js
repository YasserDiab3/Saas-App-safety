...
(function (global) {
  const DICT = {
    ar: {
      ...
      su_work_email: 'استخدم بريد المؤسسة الرسمي (مثل admin@company.com) — وليس Gmail أو Hotmail أو بريداً شخصياً آخر.',
      ...
      pf_dev_note: 'جلسات الأجهزة للمستخدمين — تُحدَّث عند الدخول وأثناء الاستخدام. اضغط «تحديث» لجلب أحدث ظهور. الموقع التقريبي من IP؛ الإحداثيات الدقيقة تظهر فقط إن سمح المستخدم بالموقع.',
    ...
    en: {
      ...
      su_work_email: 'Use your organization work email (e.g. admin@company.com), not Gmail, Hotmail, or other personal accounts.',
      ...
      pf_dev_note: 'User device sessions update on login and while using the app. Click Refresh for the latest last-seen time. Location is approximate from IP; GPS appears only if the user granted location permission.',
      pf_export_excel: 'Excel', pf_export_pdf: 'PDF',
