    ...
    setLanguage(lang, isInitialLoad = false) {
        ...
        const translations = {
            ar: {
                ...
                'dash.safetyMetricsNote': 'ملاحظة: TRIR/LTI/SR/AFR/FAR/IR وأيام العمل تحسب مع ModMetrics للعام الحالي {year} بنفس نطاق المشروع.',
            ...
            en: {
                ...
                'dash.safetyMetricsNote': 'Note: TRIR, LTI, SR, AFR, FAR, IR, and man-days use ModMetrics for the current year {year} within the project scope.',
