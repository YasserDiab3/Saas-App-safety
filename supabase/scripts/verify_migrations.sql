...
-- 8) Migration history (CLI tracking) — expect 27 rows after 0027
select version, name from supabase_migrations.schema_migrations order by version;
select 'migration_count' as check_name, (select count(*) = 27 from supabase_migrations.schema_migrations) as ok;
